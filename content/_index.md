...
>
> To speed up the availability of the {{% obitools4 %}} command documentation, a first
> version of the help pages has been automatically generated by an AI assistant. These
> pages are marked with a warning banner at the top. They should be treated with extra
> care until they have been reviewed and validated by the {{% obitools4 %}} development
> team.
>
